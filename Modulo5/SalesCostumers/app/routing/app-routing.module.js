...
var routes = [
    ...
    { path: 'costumer-list', component: costumer_list_component_1.CostumerListComponent },
    { path: 'costumer/detail/:id', component: costumer_detail_component_1.CostumerDetailComponent },
    { path: 'line-item-list', component: line_item_list_component_1.LineItemListComponent },
    { path: 'line-item/detail/:salesInvoiceId', component: line_item_detail_component_1.LineItemDetailComponent },
    { path: 'sales-invoice-list', component: sales_invoice_list_component_1.SalesInvoiceListComponent },
    { path: 'sales-invoice/detail/:id', component: sales_invoice_detail_component_1.SalesInvoiceDetailComponent }
];
